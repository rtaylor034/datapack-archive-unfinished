...
#USE HEADER
data modify block 0 0 0 front_text.messages[0] set value '[{"text":" Use ","color":"white","bold":false,"italic":false},{"score":{"name":"get.use","objective":"var"},"color":"white","bold":false,"italic":false},{"text":":","color":"white","bold":false,"italic":false}]'
...
#if has waittime
execute if data storage cmd:var get.a.uses[0].maxWait run data modify block 0 0 0 front_text.messages[0] set value '[{"text":"  "},{"nbt":"get.a.uses[0].energyCost","storage":"cmd:var","color":"yellow","bold":false,"italic":false},{"text":" | ","color":"gray","bold":false,"italic":false},{"nbt":"get.cooltext","storage":"cmd:var","interpret":true,"color":"gray","bold":false,"italic":false},{"text":"s | ","color":"gray","bold":false,"italic":false},{"nbt":"get.waittext","storage":"cmd:var","interpret":true,"color":"red","bold":false,"italic":false},{"text":"s","color":"red","bold":false,"italic":false}]'
#if not
