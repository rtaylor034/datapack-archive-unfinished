...
execute as @e[type=minecraft:area_effect_cloud,tag=helper] at @s if blocks ~-2 ~-1 ~-2 ~2 ~-1 ~-2 ~-2 ~-7 ~-2 all at @e[type=minecraft:area_effect_cloud,tag=origin] run spreadplayers ~ ~ 0 48 under 55 false @s
